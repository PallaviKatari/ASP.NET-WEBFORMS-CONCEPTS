<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wizard.aspx.cs" Inherits="SampleASP.Wizard" %>
    ...
    <asp:Wizard ID="Wizard1" runat="Server" BackColor="#C4E6E4" BorderWidth="1px" CellPadding="4" CellSpacing="2"
        ...
        <asp:Wizard ID="Wizard2" runat="server" OnFinishButtonClick="Wizard2_FinishButtonClick" OnActiveStepChanged="Wizard2_ActiveStepChanged">
            <WizardSteps>
                ...
                <b>ID:</b> <asp:TextBox ID="TextBox1" runat="Server"></asp:TextBox>
                ...
                <b>Name:</b> <asp:TextBox ID="TextBox2" runat="Server"></asp:TextBox>
                ...
                <b>Designation:</b> <asp:TextBox ID="TextBox3" runat="Server"></asp:TextBox>
